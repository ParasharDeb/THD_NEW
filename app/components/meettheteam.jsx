...
export default function MeetTheTeamSection() {
  return (
    <div className="max-w-5xl px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto" id="meettheteam">
      {/* Title */}
      ...
      <div className="mt-12 flex justify-center">
        <div className="border border-gray-200 py-2 px-3 rounded-full dark:border-neutral-700">
          <div className="flex items-center gap-x-3">
            ...
            <a
              className="inline-flex items-center gap-x-2 text-sm font-medium text-blue-600 hover:text-blue-500 focus:outline-hidden focus:text-blue-500 dark:text-blue-500 dark:hover:text-blue-600 dark:focus:text-blue-600"
              href="#"
            >
              We are hiring
              <svg
