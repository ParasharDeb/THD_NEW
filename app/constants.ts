  ...
  magazines: [
    {
      ...
      description1: 'Unleash your inner light under the transformative glow of Balis full moon.',
  ...
  teamMembers: [
    {
      name: 'Jacob Jose',
      role: 'New York Times',
      quote: 'Unlimited, instant access to hundreds of premium quality resources created by designers.',
